...
export const available_commands = new Set(["about", "education", "clear", "help"])
...
export function WrongCommand() {
  return (
    <div>
      command not found. type <span id="highlight">help</span> to display all available commands.
    </div>
  )
}
